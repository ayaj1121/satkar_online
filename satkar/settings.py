"""
Django settings for satkar project.
...
SECRET_KEY = 'hyt%_b%)5&_z9mvcsnqga5m$y7ls8$5^j*800n5sz=m@=ufvjy'
...
WSGI_APPLICATION = 'satkar.wsgi.application'
